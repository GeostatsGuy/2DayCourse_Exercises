...
par(mfrow=c(2,1))                              # set up a 2x2 matrix of plots 
...
por.vg.iso = variogram(NPorosity~1,mydata,cutoff = 3000,width =400,alpha = 35.0,tol.hor=90.0) # isotropic N[porosity]
...
por.vg.035 = variogram(NPorosity~1,mydata,cutoff = 3000,width =500,alpha = 35.0,tol.hor=22.5) # Calculate directional variograms of N[Porosity]
